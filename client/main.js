...
// creates the card for songs/responses
...
const updateHandler = (e) => {
    e.preventDefault()
    axios.put(`${baseUrl}/api/song/${songId.value}?newArtist=${updateArtist.value}&newSongName=${updateSong.value}`)
    .then (res => createSongCard(res.data))
    .catch(err => console.error(err))
}
